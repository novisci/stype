...
`stype` provides an extensible set of data types that in themselves extend certain `R` vector classes to be useful in NoviSci's suite of analytic applications by providing vectors with:
